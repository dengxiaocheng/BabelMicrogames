...
rm -f "${PREFIX:-/data/data/com.termux/files/usr}/bin/m"
cat << 'EOF' > "${PREFIX:-/data/data/com.termux/files/usr}/bin/m"
#!/data/data/com.termux/files/usr/bin/sh
...
exit "$status"
EOF
chmod +x "${PREFIX:-/data/data/com.termux/files/usr}/bin/m"
hash -r
echo "reinstalled: ${PREFIX:-/data/data/com.termux/files/usr}/bin/m"
